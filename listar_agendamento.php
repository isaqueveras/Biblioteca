...
<div class="container theme-showcase" role="main">
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
	    ...
	    <li class="breadcrumb-item active" aria-current="page"><i class="fa fa-book"> </i> Lista de Agendamento </li>
	  </ol>
	</nav>
    ...
    <form method="GET" action="pesquisa_usuarios.php">
      <div class="col-md-12">
          ...
          <div class="input-group">
						<input required type="text" name="pesquisa" class="form-control" id="pesquisa" placeholder="Pesquisar Agendamento">
			...
			<div class="table-responsive">
				<table class="table table-striped table-hover table-responsive">
					...
					<tbody>
						<tr>
                            <td>1</td>
                            <td>Isaque Veras de Oliveira</td>
                            <td>Isaque@gmail.com</td>
                            <td>Reunião com os Clientes</td>
                            <td>09:00h</td>
                            <td>
                        ...
                        <tr>
                            <td>2</td>
                            <td>Ismael Veras de Oliveira</td>
                            <td>Ismael@gmail.com</td>
                            <td>Reunião com Advogados</td>
                            <td>15:20h</td>
                            <td>
									<a href="administrativo.php?link=5&id=20">
									<button type="button" class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="bottom" title="Exibir" data-original-title="Exibir"><i class="fa fa-list-ul"> </i> Exibir</button></a>
